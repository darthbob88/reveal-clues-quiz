...
export const testQuizzes: Quiz[] = [
    {
        ...
        questions: [
            ...
            },
            {
                ...
                answer: "Indiana",
                revealOnAnswer:
                    "Sources: [Slocum Mechanical Puzze Collection](https://www.atlasobscura.com/places/slocum-mechanical-puzzle-collection) [Mentone Egg](https://www.atlasobscura.com/places/mentone-egg)  [Kokomantis](https://www.atlasobscura.com/places/kokomantis-scrap-art-sculpture) [Hoosier Hill](https://www.atlasobscura.com/places/hoosier-hill)",
            },
            {
                clues: [
    ...
    },
    {
        ...
        questions: [
            ...
            {
                clues: ["Mike Dirnt", "Tre Cool", "Billie Joe Armstrong"],
                answer: "Green Day",
            },
            {
                clues: ["Bill Ward", "Geezer Butler", "Tony Iommi", "Ozzy Osbourne"],
            ...
            {
                clues: ["Doug Clifford", "Stu Cook", "Tom Fogerty", "John Fogerty"],
                answer: "Creedence Clearwater Revival",
            },
            {
                clues: ["Alex Lifeson", "Geddy Lee", "Neil Peart"],
                answer: "Rush",
            },
            {
                clues: ["Adam Clayton", "Larry Mullen Jr", "The Edge", "Bono"],
                answer: "U2",
            },
            {
                clues: ["Paul Cook", "Steve Jones", "Johnny Rotten", "Sid Vicious"],
                answer: "The Sex Pistols",
            },
            {
                clues: ["Andy Summers", "Stewart Copeland", "Sting"],
                answer: "Police",
            },
            {
                clues: ["Krist Novoselic", "Dave Grohl", "Kurt Cobain"],
                answer: "Nirvana",
            },
        ],
    },
